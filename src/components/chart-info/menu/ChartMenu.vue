<template>
  <div
    ...
    "
  >
    <div class="relative inline-block text-left w-full mb-5">
      <div>
        <button
      ...
      <div
        :class="{
          'origin-top-right absolute right-0 mt-2 w-full rounded-md shadow-lg bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 transition duration-150 ease-in-out': true,
